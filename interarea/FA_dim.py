...
def apply_FA(sess, bin_width, subset):
...
sessions = ['105l001p16', '106r001p26', '106r002p70', '107l002p67', '107l003p143']
bin_width = 80
...
for i in range(len(sessions)):
    ...
    file_name = 'FA_output' + sess
    
    output_path = '/media/storage2/joana/PhD/V1-V2_analysis/FA_analysis/' + file_name + '_2.npy'
