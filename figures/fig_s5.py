# -*- coding: utf-8 -*-
"""
Supplementary Figure S5 -- supports Figure 5 (Interarea shared variability is dominated by population rate and mediated by choristers)

Planned panels
--------------
a. During spontaneous data, aligned RFs across areas are more correlated in a like-to-like manner
...
def make_figure():
    """Build Supplementary Figure S5 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_S5.pdf'))
