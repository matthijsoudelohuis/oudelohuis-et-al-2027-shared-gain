# -*- coding: utf-8 -*-
"""
Supplementary Figure S1 -- supports Figure 1 (Heterogeneous additive and multiplicative modulation exists across neurons; prior affine framework cannot explain it)

Planned panels
--------------
a. Example neurons
b. Radius dependence (local vs. global)
c. Comparison of behavioral proxies
...
def make_figure():
    """Build Supplementary Figure S1 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_S1.pdf'))
