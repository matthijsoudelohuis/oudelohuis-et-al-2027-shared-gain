# -*- coding: utf-8 -*-
"""
Supplementary Figure S3 -- supports Figure 3 (Heterogeneous gain modulation explains tuning-dependent noise correlations)

Planned panels
--------------
a. Tuning-dependent noise correlations for example neurons and example model situations
b. Stimulus-dependence of noise correlations, comparison of linear vs. nonlinear TF predictions
...
def make_figure():
    """Build Supplementary Figure S3 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_S3.pdf'))
