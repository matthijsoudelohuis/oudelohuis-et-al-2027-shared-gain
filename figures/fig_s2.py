# -*- coding: utf-8 -*-
"""
Supplementary Figure S2 -- supports Figure 2 (Nonlinear transfer functions link additive population input to heterogeneous output modulation)

Planned panels
--------------
a. Preferred orientation is left intact
b. TF fitting procedure
c. Model comparison
d. Relationship of TF exponent to OSI, baseline firing rate, depth
...
def make_figure():
    """Build Supplementary Figure S2 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_S2.pdf'))
