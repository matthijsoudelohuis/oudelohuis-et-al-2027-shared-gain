# -*- coding: utf-8 -*-
"""
Supplementary Figure S7 -- supports Figure 7 (Heterogeneous gain modulation shapes sensory coding)

Planned panels
--------------
a. Cross-gain decoding
b. Fisher information derivation
...
def make_figure():
    """Build Supplementary Figure S7 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_S7.pdf'))
