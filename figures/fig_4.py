# -*- coding: utf-8 -*-
"""
Figure 4 -- Nonlinear population gain modulation produces a characteristic cone geometry of the sensory manifold, whose properties are directly predicted by the gain framework

Moving from pairwise to full population geometry -- a natural escalation of the story.

Planned panels
--------------
a. Cone geometry in V1: stimulus manifold is radially scaled by population rate
b. Multiplicative modulation responsible for cone-like shape, additive for activity perpendicular to stimulus manifold. Neither explains the actual shape.
c. Actual shape is more like a bullet. Cut one section, show nonlinear projection. Exponential fit better than linear.
d. Warped cone arises from nonlinear TF (nonlinear deformation at high gain)
...
def make_figure():
    """Build Figure 4 at final print size (183 x 247 mm, full page).
...
if __name__ == '__main__':
    fig = make_figure()
    save_pdf(fig, os.path.join(FIGDIR, 'Figure_4.pdf'))
